...
const BillboardsData = [
  ...
  {
    _id: 2,
    name: "Explore The Glasses Collection ",
    date: "june 22th,2023",
  },
  {
    _id: 3,
    name: "Explore The Shirts Collection ",
    date: "june 10th,2023",
  },
];
const index = () => {
    ...
    <div className="max-w-[1280px] m-auto">
      <div className="wrapper p-8 flex flex-col gap-4 capitalize">
        <div className="flex justify-between">
          <div>
            <h1 className="font-semibold text-2xl">BillBoards</h1>
          ...
          <Button style={{ background: "black", color: "white" }}>
            <Link
              to="/billboards/managebillboard/add"
          ...
          <div className="billboards border border-gray-border rounded-md">
            <TableContainer>
              <Table variant="simple">
                <TableCaption>Trendify Billboards</TableCaption>
                <Thead>
                  <Tr>
                    <Th>Label</Th>
                    <Th>Date</Th>
                          ...
                          <Popover placement="bottom-end">
                            ...
                            <PopoverContent width={150}>
                              ...
                              >
                                ...
                                <Link
                                  to={`/billboards/managebillboard/edit?id=${value._id}`}
                                  className="flex gap-2 p-2 hover:bg-container-white transition-all cursor-pointer"
                                >
                                  <BiSolidEdit />
                                  Update
