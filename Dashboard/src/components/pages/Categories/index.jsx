...
const BillboardsData = [
  ...
  },
  {
    _id: 2,
    name:"glases",
    billboard: "Explore The Glasses Collection ",
    date: "june 22th,2023",
  },
  {
    _id: 3,
    name:"Shirts",
    billboard: "Explore The Shirts Collection",
    date: "june 10th,2023",
  },
];
const index = () => {
      ...
      <div className="wrapper p-8 flex flex-col gap-4 capitalize">
        <div className="flex justify-between">
          ...
          <Button style={{ background: "black", color: "white" }}>
            <Link
              to="/Categories/manageCategories/add"
          ...
          <div className="billboards border border-gray-border rounded-md">
            <TableContainer>
              <Table variant="simple">
                <TableCaption>Trendify Categories</TableCaption>
                <Thead>
                  <Tr>
                    <Th>Label</Th>
                    <Th>billboard</Th>
                          ...
                          <Popover placement="bottom-end">
                            ...
                            <PopoverContent width={150}>
                              ...
                              >
                                ...
                                <Link
                                  to={`/Categories/manageCategories/edit?id=${value._id}`}
                                  className="flex gap-2 p-2 hover:bg-container-white transition-all cursor-pointer"
                                >
                                  <BiSolidEdit />
                                  Update
