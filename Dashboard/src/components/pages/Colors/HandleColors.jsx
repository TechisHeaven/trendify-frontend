...
const HandleCategories = () => {
  ...
  const [value, setValue] = useState(type === "edit" ? Categories?.value.toUpperCase() : "");
        ...
        <div className="heading flex justify-between">
          <div>
            <h1 className="font-semibold text-2xl">
              {type === "add" ? "Add Colors" : "Edit Colors"}
            </h1>
            <p className="text-gray text-sm">
              {type === "add" ? "Add a Colors" : "Edit a Colors"}
            </p>
          </div>
